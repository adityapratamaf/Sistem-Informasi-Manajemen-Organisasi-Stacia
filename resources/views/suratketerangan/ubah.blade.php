        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-primary card-outline">
                    ...
                    <form action="/suratketerangan/{{ $suratketerangan->id }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nomor" class="form-control" placeholder="Nomor"
                                            autocomplete="off" value="{{ $suratketerangan->nomor }}">
                                    </div>
                                    @error('nomor')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="perihal" class="form-control" placeholder="Perihal"
                                            autocomplete="off" value="{{ $suratketerangan->perihal }}">
                                    </div>
                                    @error('perihal')
                                        <div class="alert alert-danger">
                                            Data Wajib Di Isi
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="isi" id="summernote" class="form-control" placeholder="Isi">{{ $suratketerangan->isi }}</textarea>
                                    </div>
                                    @error('isi')
                                        <div class="alert alert-danger">
                                            Data Wajib Di Isi
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tanggal" class="form-control" placeholder="Tanggal"
                                            autocomplete="off" value="{{ $suratketerangan->tanggal }}">
                                    </div>
                                    @error('tanggal')
                                        <div class="alert alert-danger">
                                            Data Wajib Di Isi
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="product-image-thumb mt-2">
                                            <embed src="{{ asset('suratketerangan-file/' . $suratketerangan->file) }}"
