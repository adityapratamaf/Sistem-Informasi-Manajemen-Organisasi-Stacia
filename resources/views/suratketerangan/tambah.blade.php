            ...
            <div class="container-fluid">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h3 class="card-title"> <b>Tambah Data Surat Keterangan</b> </h3>
                    </div>

                    <form action="/suratketerangan" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="product-image-thumb mt-2">
                                            <embed src="{{ asset('suratketerangan-file/no-document.pdf') }}" width="95"
